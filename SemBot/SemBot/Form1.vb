...
Public Class Form1
    Private readComThread As Thread
    Private terminateThread As Boolean
    Private COM_NuevaCadenaLeida As Boolean = False
    Private COM_CadenaLeida As String = ""
    Private bandera As String = ""
    Private vel As String = ""
    Private b1 As String = ""

    Private Sub Form1_Load(sender As Object, e As EventArgs) Handles Me.Load

        'Dim velocidad As String = "64"
        'MsgBox(Chr(CInt(velocidad)))
        'End
        ...
        readComThread = New Thread(AddressOf ProcessCOM)
        readComThread.Start()
    End Sub

    Private Sub Form1_Closing(sender As Object, e As CancelEventArgs) Handles Me.Closing
        Dim result As DialogResult
        result = MessageBox.Show("Está seguro de que desea Salir?", "Confirme", MessageBoxButtons.YesNo, MessageBoxIcon.Question)
    ...
    Private Sub Timer1_Tick(sender As Object, e As EventArgs) Handles Timer1.Tick
        ...
        If COM_NuevaCadenaLeida Then
            COM_NuevaCadenaLeida = False
            f = False
            If c = 1 Then
                tbEncoder.Text = COM_CadenaLeida
                c = 2

            ElseIf c = 2 Then
                TbMag.Text = COM_CadenaLeida
                c = 1
            End If
        End If
        Timer1.Enabled = True
    ...
    Private Sub ProcessCOM()
        While (Not terminateThread)
            If SerialPort1.IsOpen Then
                Try
                    COM_CadenaLeida = SerialPort1.ReadLine()
                    COM_NuevaCadenaLeida = True
                Catch ex As Exception
                    'MsgBox(ex.ToString)
                End Try
            End If
    ...
    Private Sub BtnSalir_Click(sender As Object, e As EventArgs) Handles BtnSalir.Click
        ...
        SerialPort1.Close()
        terminateThread = True
        MsgBox("Se ha cerrado el Puerto Serial, reinicie el programa si desea continuar", MsgBoxStyle.Information, "Atención!")
    End Sub
    ...
    Private Sub Timer2_Tick(sender As Object, e As EventArgs) Handles Timer2.Tick
        ...
        If Not flag Then
            ...
            Timer2.Enabled = True
        Else
            SerialPort1.Write(Chr(CInt(vel)))
            Timer1.Enabled = True
        End If
